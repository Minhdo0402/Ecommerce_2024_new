...
// import paymentIcon1 from './path/to/paymentIcon1.png';
// import paymentIcon2 from './path/to/paymentIcon2.png';
// import paymentIcon3 from './path/to/paymentIcon3.png';
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="bg-[#f7f7f7] p-5 rounded-md flex flex-col items-center justify-center gap-2">
                                    <PaymentIcons className="w-auto object-cover" />
